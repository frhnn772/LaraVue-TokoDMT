        ...
        <div class="card px-4 py-4">
            <form @submit.prevent="update()">
                <div class="mb-3">
                    ...
                    <input disabled type="number" class="form-control" id="exampleInputidproduk"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="exampleInputhargaproduk" placeholder="*contoh: 8.000" v-model="produk.harga">
                    <div v-if="validation.harga" class="text-danger">{{ validation.harga[0] }}</div>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-outline-success btn-sm float-end">Ubah Produk</button>
            </form>
        </div>
    </div>
</template>
        ...
        setup(){
            ...
            onMounted(() => {
                ...
                .then((result) =>{
                    ...
                    produk.deskripsi = result.data.data.deskripsi
                    produk.harga = result.data.data.harga
                    produk.kategori = result.data.data.kategori
                }).catch((err) => {
            ...
            function update() {
                axios.put(
                    `http://127.0.0.1:8000/api/produk/${route.params.id}`,
                    produk
                )
                .then(() => {
                    router.push({
